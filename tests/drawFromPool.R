...
print(paste("should be close to:",round(15/45,digit=2)," => ",newdis[1]))
...
print(paste("all number should be close to .5 => ", paste(apply(allres,2,sum)/100,collapse=",")))
# should be 50/50
