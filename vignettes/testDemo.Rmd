...
ip=1:N
names(ip)=ip
population=lapply(ip,function(i) list( id=as.character(i), traits=sample(c(0,1),size=z,replace=T), age=sample.int(80,1), community=sample.int(K,1), sex=sample(c("F","M"),1), repro=FALSE, partner=-1))
...
plot(1:tstep,ylim=c(0,600),type="n")
