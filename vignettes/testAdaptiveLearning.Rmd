...
apply(replicate(1000, updateTraits(k=3,k.size=100,alltraits=adaptivetraits,migrantscount=c(20,20,0,0),beta=1)),1,sum)/1000
apply(replicate(1000, updateTraits(k=3,k.size=100,alltraits=adaptivetraits,migrantscount=c(10,10,0,0),beta=0)),1,sum)/1000 #20/100 we should have 0 20% of the time
```
