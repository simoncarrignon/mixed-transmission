...
age  <- vector()
community  <- vector()
population  <- cbind(age=age,community=community)

community <- list(
                  coordinates=cbind(x=vector(mode="numeric",length=K),y=vector(mode="numeric",length=K)),
                  traits=cbind(a1=vector(mode="numeric",length=K),a2=vector(mode="numeric",length=K),a3=vector(mode="numeric",length=K)),
