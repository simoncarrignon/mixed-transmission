...
\significancestatement{Population dispersal and admixture can promote the spread of adaptive cultural traits, {\color{red}such as agriculture}, in a geographic region. 
...
{\color{red}Our model is loosely based on the interaction between farming and foraging populations during the initial stages of the adoption and diffusion of agricultural practices.}
